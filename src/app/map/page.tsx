...
export default function MapPage() {
  ...
  return (
    <div className="w-full h-[100%] relative">
      ...
      >
        <SelectTrigger className="bg-gray-300 absolute right-[15px] top-[13px] z-[401] border rounded px-3 py-1 text-sm w-[120px] cursor-pointer shadow-md">
      ...
      <input
        ...
        className="absolute right-[142px] top-[13px] z-[401] border rounded px-3 py-1 text-sm w-[60px] h-[36px] bg-gray-300 shadow-md"
        min={0}
      />
      <Select
        value={selectedType}
      ...
      >
        <SelectTrigger className="bg-gray-300 absolute right-[209px] top-[13px] z-[401] border rounded px-3 py-1 text-sm w-[120px] cursor-pointer shadow-md">
      ...
      >
        <SelectTrigger className="bg-gray-300 absolute right-[336px] top-[13px] z-[401] border rounded px-3 py-1 text-sm w-[120px] cursor-pointer shadow-md">
